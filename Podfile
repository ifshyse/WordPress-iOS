...
target 'WordPress' do
    ...
    pod 'WordPressAuthenticator', :git => 'https://github.com/wordpress-mobile/WordPressAuthenticator-iOS.git', :commit => '10006875b6d232d7eb33034fa698739cd8656e9b'
